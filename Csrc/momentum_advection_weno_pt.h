...
void weno_fifth_order_m_pt(struct DimStruct *dims, float * restrict rho0, float * restrict rho0_half,
            ...
            for(ssize_t i=imin;i<imax;i++){
                ...
                for(ssize_t j=jmin;j<jmax;j++){
                    ...
                    for(ssize_t k=kmin;k<kmax;k++){
                        ...
                        const float  vel_adv = interp_6_pt(vel_advecting[ijk + sm2_ing],
            ...
            for(ssize_t i=imin;i<imax;i++){
                ...
                for(ssize_t j=jmin;j<jmax;j++){
                    ...
                    for(ssize_t k=kmin;k<kmax;k++){
                        ...
                        const float  vel_adv = interp_6_pt( vel_advecting[ijk + sm2_ing] * rho0[k-2],
            ...
            for(ssize_t i=imin;i<imax;i++){
                ...
                for(ssize_t j=jmin;j<jmax;j++){
                    ...
                    for(ssize_t k=kmin;k<kmax;k++){
                        ...
                        const float  vel_adv = interp_6_pt(
...
void weno_seventh_order_m_pt(struct DimStruct *dims, float * restrict rho0, float * restrict rho0_half,
        float * restrict alpha0, float * restrict alpha0_half,
        float * restrict vel_advected, float * restrict vel_advecting,
        float * restrict tendency, ssize_t d_advected, ssize_t d_advecting){
            ...
            for(ssize_t i=imin;i<imax;i++){
                ...
                for(ssize_t j=jmin;j<jmax;j++){
                    ...
                    for(ssize_t k=kmin;k<kmax;k++){
                        ...
                        const float  vel_adv = interp_8_pt(
...
void weno_ninth_order_m_pt(struct DimStruct *dims, float * restrict rho0, float * restrict rho0_half,
        float * restrict alpha0, float * restrict alpha0_half,
        float * restrict vel_advected, float * restrict vel_advecting,
        float * restrict tendency, ssize_t d_advected, ssize_t d_advecting){
            ...
            for(ssize_t i=imin;i<imax;i++){
                ...
                for(ssize_t j=jmin;j<jmax;j++){
                    ...
                    for(ssize_t k=kmin;k<kmax;k++){
                        ...
                        const float  vel_adv = interp_10_pt(
