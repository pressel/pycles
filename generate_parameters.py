...
def main():
    ...
    message1 = 'Generated code! Absolutely DO NOT modify this file, parameters should be modified in generate_parameters.py \n'
    ...
    for param in parameters:
        fh.write('cdef double ' + param + ' = ' + str(parameters[param])+'\n')
    ...
    print('Generated ./parameters.pxi and ./Csrc/parameters.h with the following values:' )
    for param in parameters:
