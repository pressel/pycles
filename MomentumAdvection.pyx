...
cdef class MomentumAdvection:
    def __init__(self, namelist, ParallelMPI.ParallelMPI Pa):
        try:
            ...
            Pa.root_prPy_ssize_t('momentum_transport order not given in namelist')
    ...
    cpdef update(self, Grid.Grid Gr,ReferenceState.ReferenceState Rs, PrognosticVariables.PrognosticVariables PV, ParallelMPI.ParallelMPI Pa):
        ...
        cdef:
            ...
            Py_ssize_t shift_advected    #Shift to beginning of momentum (velocity) component in the PV.values array
            Py_ssize_t shift_advecting   #Shift to beginning of advecting velocity componentin the PV.values array
            Py_ssize_t shift_flux        #Shift to the i_advecting, i_advected flux component in the self.flux array
