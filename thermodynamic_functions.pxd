cdef extern from "thermodynamic_functions.h":
    ...
    inline double virtual_temperature_c(const double T, const double qt, const double qv) nogil
    inline double thetav_c(const double p0, const double T, const double qt, const double qv) nogil
