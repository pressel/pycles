...
cdef extern from 'momentum_diffusion.h':
    cdef void compute_diffusive_flux(Grid.DimStruct * dims, double * strain_rate, double * viscosity, double * flux, double* rho0, double* rho0_half, Py_ssize_t i1, Py_ssize_t i2)
    ...
    cpdef update(self, Grid.Grid Gr, ReferenceState.ReferenceState Rs, PrognosticVariables.PrognosticVariables PV,
        ...
        for i1 in xrange(Gr.dims.dims):
            ...
            for i2 in xrange(Gr.dims.dims):
                ...
                compute_diffusive_flux( & Gr.dims, & Ke.strain_rate[shift_flux], & DV.values[visc_shift], & self.flux[shift_flux], &Rs.rho0[0], &Rs.rho0_half[0], i1, i2)
